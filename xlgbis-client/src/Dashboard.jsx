...
export default () => {
    ...
    leftDrop.set(vw / 12 - 10, 30, vw / 12 * 11 / 2 - 20, 600)
    rightDrop.set(vw / 12 + vw / 12 * 11 / 2 + 10, 30, vw / 12 * 11 / 2 - 30, 600)

    return (
        <Container fluid className="px-0" onMouseDown={(evt) => beginDrag(evt)} onMouseUp={(evt) => endDrag(evt)} onMouseMove={(evt) => doDrag(evt)}>
            <div style={{
                position: "fixed",
